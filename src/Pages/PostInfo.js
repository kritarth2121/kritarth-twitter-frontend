...
import {fetchSinglePost, deletePost, fetchPostComments} from "../features/post/postSlice";
import Spinner from "../Components/Spinner";
import dayjs from "dayjs";
import {EditPost, NewComment, Comments, LikesModal} from "../Components/PostInfoPageComponents/index";
...
const PostInfo = () => {
    ...
    const createdAt = post !== null ? dayjs(post?.createdAt).format("h:mm A - MMM D, YYYY") : "";

    useDocumentTitle(`${post?.authorName} on Kritarth Twitter`);
            ...
            <div className="flex h-screen bg-white z-10">
                ...
                <div className="w-600 border ml-0 md:ml-28 lg:ml-0">
                    ...
                    <div className="mt-10 w-full">
                        {errMessage && <div className="text-center font-medium mt-16">{errMessage}</div>}
                        {loading ? (
                                        ...
                                        <div className="leading-tight">
                                            ...
                                            {isPostOwnedByUser && (
                                                <span className="text-gray-400 text-sm float-right">
                                                    ...
                                                    <button onClick={deleteHandler} className="small-button">
                                                        Delete
                                                    </button>
                                                </span>
                                            )}
